...
<html xmlns:wb="http://open.weibo.com/wb"><head>
    </script><script type="text/javascript" async="" src="${pageContext.request.contextPath}/assets/js/conversion.js"></script><script src="${pageContext.request.contextPath}/assets/js/allmobilize.min.js" charset="utf-8" id="allmobilize"></script><style type="text/css"></style>
    <meta content="no-siteapp" http-equiv="Cache-Control">
    <link  media="handheld" rel="alternate">
    <!-- end 云适配 -->
    <meta content="text/html; charset=utf-8" http-equiv="Content-Type">
    <title>我的简历-菜鸟实习</title>
    ...
    <link href="${pageContext.request.contextPath}/assets/css/external.min.css" type="text/css" rel="stylesheet">
    <link href="${pageContext.request.contextPath}/assets/css/popup.css" type="text/css" rel="stylesheet">
    <script type="text/javascript" src="${pageContext.request.contextPath}/assets/js/jquery.1.10.1.min.js"></script>
    <script src="${pageContext.request.contextPath}/assets/js/jquery.lib.min.js" type="text/javascript"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/assets/js/ajaxfileupload.js"></script>
    <script src="${pageContext.request.contextPath}/assets/js/additional-methods.js" type="text/javascript"></script>
    <!--[if lte IE 8]>
    <script type="text/javascript" src="${pageContext.request.contextPath}/assets/js/excanvas.js"></script>
    <![endif]-->
    <script type="text/javascript">
        var youdao_conv_id = 271546;
    </script>
    <script src="${pageContext.request.contextPath}/assets/js/conv.js" type="text/javascript"></script>
    <script src="${pageContext.request.contextPath}/assets/js/ajaxCross.json" charset="UTF-8"></script></head>
<body>
<div id="body">
    <div id="header">
        <div class="wrapper">
            <a class="logo" href="#">
                <img width="55" height="55" alt="菜鸟实习" src="${pageContext.request.contextPath}/assets/images/cainiaoLogo.jpg">
            </a>
            <ul id="navheader" class="reset">
                <li><a href="#">首页</a></li>
                <%--<li><a href="#">公司</a></li>--%>
                <%--<li><a href="#">论坛</a></li>--%>
                <li class="current"><a rel="nofollow" href="resume.jsp">我的简历</a></li>
            </ul>
            <dl class="collapsible_menu">
                <dt>
                    <span>${wxUser.name}&nbsp;</span>
                ...
                <dd><a href="accountBind.html">账号设置</a></dd>
    ...
    <div id="container">
        ...
        <div class="clearfix">
            <div class="content_l">
                <div class="fl" id="resume_name">
                    <div class="nameShow fl">
                        <h1 title="jason的简历">${wxUser.name}的简历</h1>
                        <span class="rename">重命名</span> | <a href="#">预览</a>
                    </div>
                    <form class="fl dn" id="resumeNameForm">
                        <input type="text" value="${wxUser.name}的简历" name="resumeName" class="nameEdit c9">
                        <input type="submit" value="保存"> | <a target="_blank" href="#">预览</a>
                    </form>
                </div><!--end #resume_name-->
                <div class="fr c5" id="lastChangedTime">最后一次更新：<span>2018-03-14 15:14 </span></div><!--end #lastChangedTime-->
                <div id="resumeScore">
                    <div class="score fl">
                ...
                <div class="profile_box" id="basicInfo">
                    ...
                    <div class="basicShow">
                        <span>
                            ${wxUser.name} |
                            <c:if test="${wxUser.sex == 0}">女</c:if>
                            <c:if test="${wxUser.sex ==1}">男</c:if> |
                            <c:if test="${wxUser.identity == 0}">毕业生</c:if>
                            <c:if test="${wxUser.identity ==1}">在校生</c:if> |
                            ${wxUser.region}<br>
                            ${wxUser.phone} |
                            ${wxUser.email}<br>
            			</span>
                        <div class="m_portrait">
                            <div></div>
                            <img width="120" height="120" alt="jason" src="${pageContext.request.contextPath}/assets/images/default_headpic.png">
                        </div>
                    </div><!--end .basicShow-->
                ...
                <%--期望工作--%>
                <div class="profile_box" id="expectJob" style="display: none">
                    <h2>期望工作</h2>
                        ...
                        <form class="experienceForm" >
                            <table>
                                <tbody><tr>
                                    ...
                                    <td>
                                        <input type="text" placeholder="部门名称，如：产品中心" name="positionName" class="positionName">
                                    </td>
                                </tr>
                                <tr>
                                    <td valign="top">
                ...
                <%--项目经验--%>
                <div class="profile_box" id="projectExperience" style="display: none">
                    <h2>项目经验</h2>
                    <span class="c_add dn"></span>
                ...
                <%--作品展示--%>
                <div class="profile_box" id="worksShow" style="display: none">
                    <h2>作品展示</h2>
                    <span class="c_add dn"></span>
            ...
            <div class="content_r">
                ...
                <div class="greybg qrcode mt20">
                    <img width="242" height="242" alt="拉勾微信公众号二维码" src="${pageContext.request.contextPath}/assets/images/qrcode.png">
        ...
        <div style="display:none;">
            ...
            <div class="popup" id="uploadFile">
                <table width="100%">
                    ...
                    <tr>
                        <td align="center"><img width="55" height="16" alt="loading" style="visibility: hidden;" id="loadingImg" src="${pageContext.request.contextPath}/assets/images/loading.gif"></td>
                    </tr>
                    </tbody></table>
            </div><!--/#uploadFile-->
        ...
        <script src="${pageContext.request.contextPath}/assets/js/profile.min.js" type="text/javascript"></script>
...
<script src="${pageContext.request.contextPath}/assets/js/core.min.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/assets/js/popup.min.js" type="text/javascript"></script>
